> 🔍 快速切换：首页 | [TK代理教程](/docs/PROXY_TIKTOK.md) | [物流中心教程](/docs/LOGISTICS_CENTER.md) | [openclaw部署教程](/docs/OPENCLAW_DEPLOY.md)
...
2. **配置权限**
   - (二选一)浏览器访问：[chrome://extensions/](chrome://extensions/), 找到`篡改猴`扩展，点击`详情`
   - (二选一)直接访问: `chrome://extensions/?id=dhdgffkkebhmkfjojejmpbldmpobfkfo`
   - 勾选以下选项：
     - ✅ 打开右上角的`开发者模式`
     - ✅ 允许运行用户脚本
     - ✅ 固定到工具栏
...
## 📋 IT需求文档
[IT需求管理文档链接](https://doc.weixin.qq.com/smartsheet/s3_AWEAwgbKAJwCNZFS9tBl8S7uhL5F0?scode=AK0ANwdJAAc5rEcapHAWEAwgbKAJw&tab=q979lj&viewId=vukaF8)
